...
malvin({
    ...
    desc: 'Restart the KC bot system',
    category: 'system',
    react: '♻️',
    filename: __filename,
    ownerOnly: true
    ...
    try {
        ...
        const ownerName = config.OWNER_NAME || 'KIRITO';
        const botName = config.BOT_NAME || 'KC';
...
│ 3. Contact ${config.OWNER_NAME || 'KIRITO'}
╰─────────────────────────────
`.trim(), {
            contextInfo: {
                mentionedJid: [sender],
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: config.OWNER_NAME || 'KC',
                    serverMessageId: 143
                }
            }
        });
